public class Hipoteca {
    ...
    public void     setPropiedadCasa(Casas casa) {Propiedad = casa;} // en el programa principal: si es casa (esCasa()) usa este, sino el setPropiedadDpto
    public void     setPropiedadDepto(Departamentos depto) {Propiedad = depto;} // Polimorfismo de BienesInmuebles a Departamentos/Casas
